...
def upgrade() -> None:
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.ForeignKeyConstraint(['created_by_id'], ['user.id'], name=op.f('fk_application_created_by_id_user')),
    ...
    sa.ForeignKeyConstraint(['application_id'], ['application.id'], name=op.f('fk_report_application_id_application')),
