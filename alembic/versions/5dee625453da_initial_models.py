...
Revision ID: 5dee625453da
Revises: 8a9ec8cf53ba
Create Date: 2025-05-09 10:56:27.474556
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_id"],
            ["user.id"],
            name=op.f("fk_application_created_by_id_user"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.ForeignKeyConstraint(
            ["created_by_id"], ["user.id"], name=op.f("fk_upload_created_by_id_user")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["application_id"],
            ["application.id"],
            name=op.f("fk_report_application_id_application"),
        ),
        sa.ForeignKeyConstraint(
            ["created_by_id"], ["user.id"], name=op.f("fk_report_created_by_id_user")
        ),
